...
/**
 * Added by kenny@adstruc.com on 06/15/2016
 * Button renderer
 * @param {Object} instance Handsontable instance
 * @param {Element} TD Table cell where to render
 * @param {Number} row
...
(function (Handsontable) {
  ...
  var clonableDIV = document.createElement('DIV');
  clonableDIV.className = 'htToggleableButtonRendererDiv ';

  var ToggleableButtonRenderer = function (instance, TD, row, col, prop, value, cellProperties) {
    ...
    var DIV = clonableDIV.cloneNode(false); //this is faster than createElement

    if (value === cellProperties.checkedTemplate || value === Handsontable.helper.stringify(cellProperties.checkedTemplate)) {
      DIV.className += cellProperties.defaultClasses + ' ' + cellProperties.toggleOnClass;
      TD.appendChild(DIV);
    }
    else if (value === cellProperties.uncheckedTemplate || value === Handsontable.helper.stringify(cellProperties.uncheckedTemplate)) {
      DIV.className += cellProperties.defaultClasses;
      TD.appendChild(DIV);
    }
    else if (value === null) { //default value
      DIV.className += ' ';
    ...
    if (cellProperties.readOnly) {
      ...
      $div.on('click', function(){
        if (!$div.hasClass(cellProperties.toggleOnClass)) {
          instance.setDataAtRowProp(row, prop, cellProperties.checkedTemplate);
        }
        else {
          instance.setDataAtRowProp(row, prop, cellProperties.uncheckedTemplate);
  ...
  Handsontable.ToggleableButtonRenderer = ToggleableButtonRenderer;
  Handsontable.renderers.ToggleableButtonRenderer = ToggleableButtonRenderer;
  Handsontable.renderers.registerRenderer('toggleableButton', ToggleableButtonRenderer);
...
(function(Handsontable){
  ...
  ToggleableButtonEditor.prototype.finishEditing = function () {};

  ToggleableButtonEditor.prototype.init = function () {};
  ToggleableButtonEditor.prototype.open = function () {};
  ToggleableButtonEditor.prototype.close = function () {};
  ToggleableButtonEditor.prototype.getValue = function () {};
  ToggleableButtonEditor.prototype.setValue = function () {};
  ToggleableButtonEditor.prototype.focus = function () {};

  Handsontable.editors.ToggleableButtonEditor = ToggleableButtonEditor;
  Handsontable.editors.registerEditor('toggleableButton', ToggleableButtonEditor);
...
// Added by kenny@adstruc.com on 06/15/2016
Handsontable.ToggleableButtonCell = {
  editor: Handsontable.editors.ToggleableButtonEditor,
  renderer: Handsontable.renderers.ToggleableButtonRenderer
};
...
Handsontable.cellTypes = {
  ...
  // Added by kenny@adstruc.com on 06/15/2016
  toggleableButton: Handsontable.ToggleableButtonCell,
